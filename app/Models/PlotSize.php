    ...
    public static function indexPlotSize()
    {
        ...
        return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $html = '<a href="' . route("plotSize.edit", $row->id) . '" class="btn-sm btn btn-clean btn-icon btn-light-primary me-2 p-0 " data-type="edit" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit this Company">
