...
<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
    ...
    <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
        ...
        @hasrole('Super Admin')
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Request::is('plot-types') || Request::is('plot-types/*') ? 'hover show' : '' }}">
                <span class="menu-link">
                    <span class="menu-icon">
                        <span class="svg-icon svg-icon-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <span class="menu-title">Plot Type</span>
                    <span class="menu-arrow"></span>
                </span>
                <div class="menu-sub menu-sub-accordion">
                    @if(auth()->user()->roles->first()->hasPermissionTo('Plot Type'))
                        <div class="menu-item">
                            <a class="menu-link  {{ Request::is('plot-types') ? 'active' : '' }}" href="{{ route('plot-types.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">All Plot Types</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link  {{ Request::is('plot-types/create') ? 'active' : '' }}" href="{{ route('plot-types.create') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Add Plot Type</span>
                            </a>
                        </div>
                    @endif
                </div>
        ...
        @hasanyrole('Super Admin')
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Request::is('size-dimensions') || Request::is('size-dimensions/*') ? 'hover show' : '' }}">
                <span class="menu-link">
                    <span class="menu-icon">
                        <span class="svg-icon svg-icon-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <span class="menu-title">Size Dimension</span>
                    <span class="menu-arrow"></span>
                </span>
                @if(auth()->user()->roles->first()->hasPermissionTo('Plot Size'))
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link  {{ Request::is('size-dimensions') ? 'active' : '' }}" href="{{ route('size-dimensions.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">All Plot Sizes</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link  {{ Request::is('size-dimensions/create') ? 'active' : '' }}" href="{{ route('size-dimensions.create') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Add Plot Size</span>
                            </a>
                        </div>
                    </div>
                @endif
        ...
        @hasrole('Super Admin')
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Request::is('plots') || Request::is('plots/*') ? 'hover show' : '' }}">
                <span class="menu-link">
                    <span class="menu-icon">
                        <span class="svg-icon svg-icon-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div class="menu-sub menu-sub-accordion">
                    @if(auth()->user()->roles->first()->hasPermissionTo('Plot'))
                        <div class="menu-item">
        ...
        @hasrole('Super Admin')
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Request::is('installments') || Request::is('installments/*') ? 'hover show' : '' }}">
                <span class="menu-link">
                    <span class="menu-icon">
                        <span class="svg-icon svg-icon-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <span class="menu-title">Installments</span>
                    <span class="menu-arrow"></span>
                </span>
                <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link  {{ Request::is('installments') ? 'active' : '' }}" href="{{ route('installments.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">All Installments </span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link  {{ Request::is('installments/create') ? 'active' : '' }}" href="{{ route('installments.create') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Add Installments</span>
                            </a>
                        </div>
                </div>
            </div>
