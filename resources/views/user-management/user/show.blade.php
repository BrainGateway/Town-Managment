                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header flex-wrap py-3">
                        ...
                        <div class="card-toolbar">
                            ...
                            <button type="button" class="btn btn-sm btn-primary disabled" data-bs-toggle="modal" data-bs-target="#changePassword">
                                Change Password
                            </button>
                            @endcan
                        </div>
                               ...
                               <div class="form-group col-md-12">
                                <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" disabled="disabled" name="first_name" class="form-control form-control-sm" placeholder="first name" value="{{ old("first_name", $user->first_name) }}">
                                            <!--end::Input-->
                                            @error('first_name')
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" disabled="disabled" name="last_name" class="form-control form-control-sm" placeholder="Last name" value="{{ old("last_name", $user->last_name) }}">
                                            <!--end::Input-->
                                            @error('last_name')
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                {{ $message }}
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="fv-row fv-plugins-icon-container">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="email" disabled="disabled" name="user_email" id="user_email" class="form-control form-control-sm" placeholder="example@domain.com" value="{{ old("user_email", $user->email) }}">
                                        ...
                                        <div class="form-group mb-5 col-md-4">
                                            ...
                                            <div class="d-flex fv-row">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid">
                                                    <!--begin::Input-->
                                                    <input class="form-check-input me-3 role_permissions" disabled="disabled" name="user_role[]" type="checkbox" value="only_permissions" id="only_permissions" @if( count($selectedRoles) < 0 || empty($selectedRoles) )  checked  @endif>
                                                    <!--end::Input-->
                                                    <!--begin::Label-->
                                        ...
                                        @forelse( $roles as $role )
                                            <div class="form-group mb-5 col-md-4">
                                                ...
                                                <div class="d-flex fv-row">
                                                    ...
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        <!--begin::Input-->
                                                        <input class="form-check-input me-3" disabled="disabled" name="user_role[]" type="checkbox" value="{{ $role->id }}" id="{{ $role->name }}" {{ (in_array($role->name, $selectedRoles)) ? "checked" : "" }}>
                                                        <!--end::Input-->
                                                        <!--begin::Label-->
